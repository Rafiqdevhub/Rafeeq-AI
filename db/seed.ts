...
const freeUsers = [
  {
    clerkId: "free_001",
    email: "sarahkhan12@email.com",
    name: "Sarah Khan",
    subscriptionTier: "free",
  },
  {
    clerkId: "free_002",
    email: "mahnoor1122@email.com",
    name: "Mahnoor Ali",
    subscriptionTier: "free",
  },
  {
    clerkId: "free_003",
    email: "javadkhan@email.com",
    name: "Javad Khan",
    subscriptionTier: "free",
  },
  {
    clerkId: "free_004",
    email: "alirehman1232@email.com",
    name: "Ali Rehman",
    subscriptionTier: "free",
  },
  {
    clerkId: "free_005",
    email: "sanankhan@email.com",
    name: "Sanan Khan",
    subscriptionTier: "free",
  },
];
...
const proUsers = [
  {
    ...
    email: "Alirazakhan12@gmail.com",
    name: "Ali Raza Khan",
    subscriptionTier: "pro",
  },
  {
    clerkId: "pro_002_temp",
    email: "alikulkarni09@gmail.com",
    name: "Ali Kulkarni",
    subscriptionTier: "pro",
  },
  {
    clerkId: "pro_003",
    email: "Ehsankhan@email.com",
    name: "Ehsan Khan",
    subscriptionTier: "pro",
  },
  {
    clerkId: "pro_004",
    email: "mahnoorjavid@email.com",
    name: "Mahnoor Javid (Pro)",
    subscriptionTier: "pro",
  },
  {
    clerkId: "pro_005",
...
async function comprehensiveSeed() {
  ...
  try {
    ...
    const matchPairs = [
      // PRO to PRO matches
      ["Ehsan Khan", "Mahnoor Javid (Pro)", "Modern Full Stack Next.js Course"],
      ["Sofia Rehman", "Aisha Patel (Pro)", "Ankita's Youtube Community"],
      ["David Kim (Pro)", "Maya Anderson (Pro)", "AI & Machine Learning"],
      ["James Wilson (Pro)", "Lucas Martinez (Pro)", "Cloud & DevOps"],
      ["Ehsan Khan", "David Kim (Pro)", "AI & Machine Learning"],
      ["Mahnoor Javid (Pro)", "James Wilson (Pro)", "Cloud & DevOps"],
      ["Nina Silva (Pro)", "Sofia Rehman", "Developer to Leader"],
      ["Alex Taylor (Pro)", "Lucas Martinez (Pro)", "Cloud & DevOps"],
      ["Ali Raza Khan", "Ali Kulkarni", "Ankita's Youtube Community"],

      // FREE to PRO matches (showing FREE users can match within limits)
      ["Sarah Khan", "Ehsan Khan", "Modern Full Stack Next.js Course"],
      ["Mahnoor Ali", "David Kim (Pro)", "Python for Data Science"],
      ["Ali Rehman", "Mahnoor Javid (Pro)", "Developer to Leader"],
    ];
    ...
    console.log("\n💡 YOUR ACCOUNTS (PRO):");
    console.log("   • Alirazakhan12@gmail.com");
    console.log("   • alikulkarni09@gmail.com");
    console.log("\n💡 OTHER TEST ACCOUNTS:");
    console.log("   • sarahkhan12@email.com (FREE)");
    console.log("   • Ehsankhan@email.com (PRO)\n");
